...
class LeadDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (arguments == null || arguments.isEmpty) {
      ...
      return Scaffold(
        body: Center(child: CircularProgressIndicator(color: colorMainTheme)),
      );
    }

    final String leadId = arguments[0];
    final Lead? initialData = arguments.length > 1 ? arguments[1] : null;
    final bool alreadyRegistered = Get.isRegistered<LeadDetailsController>(
      tag: leadId,
    );
    ...
    if (alreadyRegistered) {
      try {
        controller = Get.find<LeadDetailsController>(tag: leadId);
        if (controller.lead == null && initialData == null) {
          Get.delete<LeadDetailsController>(tag: leadId);
          controller = Get.put<LeadDetailsController>(
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        //     colors: [
        //       Color(0xFFE8F2FF),  // Soft sky blue-white (thoda zyada visible)
        //       Color(0xFFFFF5F5),  // Very light warm peach
        //       Color(0xFFF0FFFB),  // Soft mint touch
        //       Color(0xFFFFFBF8),  // Warm off-white
        //       Color(0xFFF5F8FF),  // Light lavender-white
        //     ],
        ...
        child: Stack(
          children: [
            ...
            //   top: -80,
            //   right: -80,
            //   child: _bubble(320, colorMainTheme.withOpacity(0.08)),
            // ),
            // Positioned(
            //   top: 140,
            //   right: -40,
            //   child: _bubble(220, Colors.purple.shade100.withOpacity(0.12)),
            // ),
            // Positioned(
            //   bottom: -100,
            //   left: -100,
            //   child: _bubble(380, Colors.cyan.shade100.withOpacity(0.2)),
            // ),
            // Positioned(
            //   bottom: 170,
            //   left: -60,
            //   child: _bubble(160, colorMainTheme.withOpacity(0.09)),
            // ),
            GetBuilder<LeadDetailsController>(
              tag: leadId,
              builder: (controller) {
                ...
                final nextUpcomingIndex =
                    lead.followUpLeads?.indexWhere((item) {
                        ...
                        children: [
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        color:
                                            controller.locationAddress == null
                                            ? colorGreyText
                                            : colorBlack,
                          ...
                          Obx(
                            () => CustomButton(
                              ...
                              label: controller.isUpdating
                                  ? 'Saving Changes...'
                                  : 'Save Changes',
                              backgroundColor: controller.isUpdating
                                  ? colorGreyText
                                  : colorMainTheme,
                              boarderRadius: 8,
                            ),
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  AnimatedRotation(
                                    turns: controller.isDetailsExpanded
                                        ? 0.5
                                        : 0,
                                  ...
                                  CustomCard(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        if (hasValue(lead.clientAltPhone))
                                          _infoCard(
                                            title: "Alternative Contact Number",
                                            value: lead.clientAltPhone!,
                                            trailing: Row(
                                              mainAxisSize: MainAxisSize.min,
                                              children: [
                                                if (controller.isAdmin) ...[
                                        ...
                                        if (lead.latitude != null &&
                                          ...
                                          GestureDetector(
                                            onTap: () =>
                                                controller.openDirectionsToLead(
                                                  lead.latitude!,
                                                  lead.longitude!,
                                                ),
                                            child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    SearchableCSCDropdown(
                                      ...
                                      hintText:
                                          controller.selectedResponse.isNotEmpty
                                    ...
                                    CustomTextFormField(
                                      ...
                                      controller: controller.noteCallController,
                                      textCapitalization:
                                          TextCapitalization.words,
                                      keyboardType: TextInputType.multiline,
                                      textInputAction: TextInputAction.newline,
                                      focusNode: controller.fnNoteCall,
                                      maxLines: 3,
                                      validator: (value) {
                                        if (value == null || value.isEmpty) {
